...
SCALE	= lib.ecma.require(@lib.model.cRAR.scale.core);
...
EXPORT.degeneracy		= lib.profile.axis('map', @(obj) ANCH.velocity_core.map(obj,MAP.degeneracy) - MAP.degeneracy.map(obj), 'label', '$\theta_c - \theta(r)$');