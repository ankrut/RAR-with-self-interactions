...
SCALE	= lib.ecma.require(@lib.model.cRAR.scale.plateau);
...
EXPORT.degeneracy		= lib.profile.axis('map', @(obj) ANCH.velocity_plateau.map(obj,MAP.degeneracy) - MAP.degeneracy.map(obj), 'label', '$\theta_p - \theta(r)$');